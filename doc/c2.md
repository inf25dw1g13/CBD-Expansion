...
A API disponibiliza 6 recursos principais na base de dados (MariaDB): Restaurantes, Pratos, Clientes, Ingredientes, Entregas e Pedidos; cada um com as respetivas operações CRUD essenciais: post, get, put e delete.
